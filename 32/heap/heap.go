...
// Package heap has 32-bit macro functions, callable from a third-party macros.
package heap
...
func Push(ts0 *[1]uintptr, compar func(*uint32, *uint32) int, heap *[]uint32, elem []uint32) {
	incr := int((*ts0)[0])
	_ = incr
...
func Remove(ts0 *[1]uintptr, compar func(*uint32, *uint32) int, heap *[]uint32, i int) {
	incr := int((*ts0)[0])
	_ = incr
...
func Another(ts0 *[1]uintptr, compar func(*uint32, *uint32) int, heap []uint32) {
	incr := int((*ts0)[0])
	_ = incr
...
func Fix(ts0 *[1]uintptr, compar func(*uint32, *uint32) int, heap []uint32, i int) {
	incr := int((*ts0)[0])
	_ = incr
...
func Heapify(ts0 *[1]uintptr, compar func(*uint32, *uint32) int, dst []uint32, heap []uint32) {
	incr := int((*ts0)[0])
	_ = incr
...
func up(ts0 *[1]uintptr, compar func(*uint32, *uint32) int, heap []uint32, j int) {
	incr := int((*ts0)[0])
	_ = incr
...
func down(ts0 *[1]uintptr, compar func(*uint32, *uint32) int, heap []uint32, i, n int) {
	incr := int((*ts0)[0])
	_ = incr

	for {
		j1 := 2*i + 1
		if j1 >= n || j1 < 0 { // j1 < 0 after uint32 overflow
			break
		}
		j := j1 // left child
