...
// Package heap has 8-bit macro functions, callable from a third-party macros.
package heap
...
func Push(ts0 *[1]uintptr, compar func(*uint8, *uint8) int, heap *[]uint8, elem []uint8) {
	incr := int((*ts0)[0])
	_ = incr
...
func Remove(ts0 *[1]uintptr, compar func(*uint8, *uint8) int, heap *[]uint8, i int) {
	incr := int((*ts0)[0])
	_ = incr
...
func Another(ts0 *[1]uintptr, compar func(*uint8, *uint8) int, heap []uint8) {
	incr := int((*ts0)[0])
	_ = incr
...
func Fix(ts0 *[1]uintptr, compar func(*uint8, *uint8) int, heap []uint8, i int) {
	incr := int((*ts0)[0])
	_ = incr
...
func Heapify(ts0 *[1]uintptr, compar func(*uint8, *uint8) int, dst []uint8, heap []uint8) {
	incr := int((*ts0)[0])
	_ = incr
...
func up(ts0 *[1]uintptr, compar func(*uint8, *uint8) int, heap []uint8, j int) {
	incr := int((*ts0)[0])
	_ = incr
...
func down(ts0 *[1]uintptr, compar func(*uint8, *uint8) int, heap []uint8, i, n int) {
	incr := int((*ts0)[0])
	_ = incr

	for {
		j1 := 2*i + 1
		if j1 >= n || j1 < 0 { // j1 < 0 after uint8 overflow
			break
		}
		j := j1 // left child
